...
void tap_dance_on_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (get_action_type(state)) {
        case ACTION_SINGLE_TAP  : register_code(action_codes->on_single_tap)  ; break;
        case ACTION_SINGLE_HOLD : register_code(action_codes->on_single_hold) ; break;
        case ACTION_DOUBLE_TAP  : register_code(action_codes->on_double_tap)  ; break;
        case ACTION_DOUBLE_HOLD : register_code(action_codes->on_double_hold) ; break;
        case ACTION_TRIPLE_TAP  : register_code(action_codes->on_triple_tap)  ; break;
        case ACTION_TRIPLE_HOLD : register_code(action_codes->on_triple_hold) ; break;
        default: break;
    }
}
...
void tap_dance_on_reset(tap_dance_state_t *state, void *user_data) {
    tap_dance_action_codes_t *action_codes = (tap_dance_action_codes_t *)user_data;
    switch (get_action_type(state)) {
        case ACTION_SINGLE_TAP  : unregister_code(action_codes->on_single_tap)  ; break;
        case ACTION_SINGLE_HOLD : unregister_code(action_codes->on_single_hold) ; break;
        case ACTION_DOUBLE_TAP  : unregister_code(action_codes->on_double_tap)  ; break;
        case ACTION_DOUBLE_HOLD : unregister_code(action_codes->on_double_hold) ; break;
        case ACTION_TRIPLE_TAP  : unregister_code(action_codes->on_triple_tap)  ; break;
        case ACTION_TRIPLE_HOLD : unregister_code(action_codes->on_triple_hold) ; break;
        default: break;
    }
}
